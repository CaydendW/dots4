def blood(c, options = {}):
    palette = {
        ...
        'background-attention': '#4b515c',
        'border': '#61afef',
        'current-line': '#61afef',
        'selection': '#98c379',
        'foreground': '#abb2bf',
        'foreground-alt': '#abb2bf',
        'foreground-attention': '#abb2bf',
        'comment': '#abb2bf',
        'cyan': '#61afef',
        'green': '#98c379',
        'orange': '#d19a66',
    ...
    # ## Type: QtColor
    c.colors.tabs.selected.even.bg = palette['background-attention']
    ...
    # ## Type: QtColor
    c.colors.tabs.selected.odd.bg = palette['background-attention']
